...
export const DEFAULT_CONNECTOR_NAME = "Pi with ChatGPT";
...
/** What the client should do to THIS workspace's ChatGPT connector.
 ...
 * A workspace already recorded without a title stays on the legacy
 * "Codex with ChatGPT" name. A new workspace uses the Pi product name.
 */
